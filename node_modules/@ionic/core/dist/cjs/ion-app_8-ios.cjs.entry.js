...
class RouterOutlet {
    ...
    async setRoot(component, params, opts) {
        ...
        const enteringEl = await __chunk_8.attachComponent(this.delegate, this.el, component, ['ion-page', 'ion-page-invisible'], params);
        this.activeComponent = component;
        this.activeEl = enteringEl;
        // commit animation
        await this.commit(enteringEl, leavingEl, opts);
        await __chunk_8.detachComponent(this.delegate, leavingEl);
        return true;
    }
    async transition(enteringEl, leavingEl, opts = {}) {
        ...
        await __chunk_9.transition(Object.assign({ mode,
            animated,
            animationBuilder,
            enteringEl,
