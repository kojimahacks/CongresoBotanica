    ...
    componentDidLoad() {
        rIC(() => {
            ...
            if (config.getBoolean('statusTap', isPlatform(window, 'hybrid'))) {
                import('./status-tap-a777fe7a.js').then(module => module.startStatusTap());
            }
...
class RouterOutlet {
    ...
    async componentDidLoad() {
        this.gesture = (await import('./swipe-back-560f72e7.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart(), () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
